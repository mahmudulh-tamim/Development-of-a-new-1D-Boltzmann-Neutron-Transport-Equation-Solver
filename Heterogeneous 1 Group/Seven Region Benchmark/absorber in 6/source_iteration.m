...
mesh_length_6=mesh_length_absorber;
...
x_region_6=(3*thickness_reflector+2*thickness_fuel:mesh_length_absorber:3*thickness_reflector+2*thickness_fuel+thickness_absorber)';
x_region_7=(3*thickness_reflector+2*thickness_fuel+thickness_absorber:mesh_length_reflector:4*thickness_reflector+2*thickness_fuel+thickness_absorber)';
...
vect_sigma_t(mesh_count_region_5+1:mesh_count_region_6,1)=sigma_t_absorber;
...
vect_sigma_s(mesh_count_region_5+1:mesh_count_region_6,1)=sigma_s_absorber;
...
vect_nu_sigma_f(mesh_count_region_5+1:mesh_count_region_6,1)=nu_sigma_f_absorber;
